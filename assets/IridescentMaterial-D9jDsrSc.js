import{Et as e,jt as t,rt as n}from"./vendor-q8RIdIwp.js";var r=`uniform float uTime;
...
`;function a(a,o){return new e({uniforms:{uTime:{value:0},uScroll:{value:0},uDepth:{value:0},uHeat:{value:0},uMouse:{value:new t(.5,.5)},uColor1:{value:new n(a)},uColor2:{value:new n(o)}},vertexShader:r,fragmentShader:i})}export{a as t};