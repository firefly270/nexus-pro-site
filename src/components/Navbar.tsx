      ...
      <header className="fixed top-3 right-3 z-50" role="banner">
        <div className="flex items-center gap-1.5 bg-black/60 backdrop-blur-xl border border-white/[0.06] rounded-full px-2.5 py-1.5 shadow-lg">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <button onClick={() => useBoundStore.getState().toggleGraphView()} className="flex items-center justify-center w-5 h-5 text-zinc-500 hover:text-zinc-300 transition-colors rounded-full hover:bg-zinc-800/50" aria-label="Toggle graph view">
